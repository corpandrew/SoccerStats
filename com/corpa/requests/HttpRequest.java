...
public class HttpRequest {
    ...
    private static String getResponse(RequestType requestType, @Nullable Parameters params) {
        ...
        try {
            response = Unirest.get(link)
                    .header("X-Mashape-Key", Utils.API_KEY)
    ...
    public enum RequestType {
        ...
        LEAGUE_MANAGERS_IN_A_SEASON("https://sportsop-soccer-sports-open-data-v1.p.mashape.com/v1/leagues/league_slug/seasons/season_slug/teams/team_slug/managers", Managers.class),
        LEAGUE_REFEREE_IN_SEASON("https://sportsop-soccer-sports-open-data-v1.p.mashape.com/v1/leagues/league_slug/seasons/season_slug/referees", Referees.class),
